...
def activarfuncion(request, ticket_id):
    """Activa una función especial en un ticket"""
    try:
        ...
        ticket.activar_funcion(funcion_key, **kwargs)
        
        return JsonResponse({
            'success': True,
            'mensaje': f'Función {funcion_key} activada correctamente',
