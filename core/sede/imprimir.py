...
def imprimir(request):
    """GET /api/sede/ticket/print/?ticket_id=<id> — Renderiza el template A5 del ticket de la sede."""
    ...
    try:
        ...
        # Generar códigos usando las nuevas funciones
        ...
        # Cargar liquidación descriptiva/remota si existe
        ...
        return render(request, 'organizacion/sede/ticket_print.html', context)
